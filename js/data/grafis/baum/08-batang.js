/* ============================================================
   BAUM — 8. Bentuk Batang (hal. 145–176)
   ============================================================ */
window.GRAFIS_AUTO_DATA_BAUM_SLIDES = window.GRAFIS_AUTO_DATA_BAUM_SLIDES || [];

/* 🖼️ Placeholder gambar — ganti satu per satu nanti */
const IMG_BATANG = 'https://raw.githubusercontent.com/Pragas123/assets/refs/heads/main/nmqo6a.png';
...
window.GRAFIS_AUTO_DATA_BAUM_SLIDES.push({
  ...
  sections: [
       ...
       ========================================================== */
    {
      ...
      items: [
        {
          image: IMG_BATANG,   // ← GANTI: batang dua garis sejajar
        ...
        {
          image: IMG_BATANG,   // ← GANTI: batang satu garis
          id: 'satu_garis',
        ...
        {
          image: IMG_BATANG,   // ← GANTI: bentuk T
          id: 'bentuk_t',
          label: 'Bentuk T',
       ...
       ========================================================== */
    {
      ...
      items: [
        {
          image: IMG_BATANG,   // ← GANTI: batang membengkak
          id: 'membengkak',
          label: 'Batang Membengkak (hal. 147)',
        ...
        {
          image: IMG_BATANG,   // ← GANTI: batang keroak
          id: 'keroak',
          label: 'Batang Keroak (hal. 148)',
        ...
        {
          image: IMG_BATANG,   // ← GANTI: batang kerucut
          id: 'kerucut',
          label: 'Batang Kerucut (hal. 149)',
        ...
        {
          image: IMG_BATANG,   // ← GANTI: batang menerobos mahkota
          id: 'menerobos_mahkota',
          label: 'Batang Menerobos Mahkota (hal. 150)',
       ...
       ========================================================== */
    {
      ...
      items: [
        {
          image: IMG_BATANG,   // ← GANTI: batang menonjol
          id: 'menonjol',
          label: 'Batang Menonjol (hal. 151–152)',
        ...
        {
          image: IMG_BATANG,   // ← GANTI: batang meliuk
          id: 'meliuk',
          label: 'Batang Meliuk (hal. 152–153)',
        ...
        {
          image: IMG_BATANG,   // ← GANTI: scribbling
          id: 'scribbling',
          label: 'Scribbling / Garis Berantakan (hal. 153–154)',
        ...
        {
          image: IMG_BATANG,   // ← GANTI: batang berbelok-belok
          id: 'berbelok_belok',
          label: 'Batang Berbelok-belok (hal. 154–155)',
        ...
        {
          image: IMG_BATANG,   // ← GANTI: batang terbuka ujungnya
          id: 'terbuka_ujungnya',
          label: 'Batang Terbuka Ujungnya (hal. 156–157)',
        ...
        {
          image: IMG_BATANG,   // ← GANTI: batang ditumpuk-tumpuk
          id: 'ditumpuk_tumpuk',
          label: 'Batang Ditumpuk-tumpuk (hal. 157–158)',
        ...
        {
          image: IMG_BATANG,   // ← GANTI: batang 3 dimensi
          id: 'tiga_dimensi',
          label: 'Batang 3 Dimensi (hal. 159–160)',
       ...
       ========================================================== */
    {
      ...
      items: [
        ...
        {
          image: IMG_BATANG,   // ← GANTI: batang terputus-putus
          id: 'terputus_putus',
          label: 'Batang Terputus-putus (hal. 164)',
        ...
        {
          image: IMG_BATANG,   // ← GANTI: batang garis lurus sejajar (dewasa)
          id: 'garis_lurus_sejajar_dewasa',
          label: 'Garis Lurus & Sejajar (digambar oleh Orang Dewasa) (hal. 165)',
        ...
        {
          image: IMG_BATANG,   // ← GANTI: batang berlubang/terkelupas
       ...
       ========================================================== */
    {
      ...
      items: [
        {
          image: IMG_BATANG,   // ← GANTI: batang condong ke kiri
          id: 'condong_kiri',
          label: 'Batang Condong ke Kiri (hal. 166–167)',
        ...
        {
          image: IMG_BATANG,   // ← GANTI: batang condong ke kanan
          id: 'condong_kanan',
          label: 'Batang Condong ke Kanan (hal. 167–168)',
       ...
       ========================================================== */
    {
      ...
      items: [
        {
          image: IMG_BATANG,   // ← GANTI: permukaan batang (umum)
          id: 'permukaan_umum',
        ...
        {
          image: IMG_BATANG,   // ← GANTI: tekstur kasar/berparut
          id: 'tekstur_kasar',
          label: 'Tekstur Kasar / Berparut / Bersisik / Berbintik (hal. 169–171)',
        ...
        {
          image: IMG_BATANG,   // ← GANTI: gelombang pada batang
          id: 'gelombang_batang',
        ...
        {
          image: IMG_BATANG,   // ← GANTI: noda pada batang
          id: 'noda_batang',
        ...
        {
          image: IMG_BATANG,   // ← GANTI: bercak pada batang
          id: 'bercak_batang',
    ...
    {
      id: 'shading',
      title: '7. Bayangan (Shading) pada Batang (hal. 173–176)',
      type: 'checkbox',
      items: [
        {
          image: IMG_BATANG,   // ← GANTI: shading kiri
          id: 'shading_kiri',
        ...
        {
          image: IMG_BATANG,   // ← GANTI: batang kaku
          id: 'kekakuan',
        ...
        {
          image: IMG_BATANG,   // ← GANTI: shading kanan
          id: 'shading_kanan',
        ...
        {
          image: IMG_BATANG,   // ← GANTI: seluruh batang dihitamkan
        ...
        {
          image: IMG_BATANG,   // ← GANTI: batang dihitamkan tekanan kuat
          id: 'tekanan_kuat',
        ...
        {
          image: IMG_BATANG,   // ← GANTI: latar belakang dihitamkan
